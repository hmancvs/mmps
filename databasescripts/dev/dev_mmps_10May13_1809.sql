...
CREATE TABLE `address` (
  ...
  KEY `fk_address_createdby` (`createdby`),
  KEY `fk_address_lastupdatedby` (`lastupdatedby`),
  KEY `index_address_isprimary` (`isprimary`),
  CONSTRAINT `fk_address_lastupdatedby` FOREIGN KEY (`lastupdatedby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_address_createdby` FOREIGN KEY (`createdby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `merchant` (
  ...
  `lastupdatedby` int(11) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_merchant_createdby` (`createdby`),
  KEY `fk_merchant_lastupdatedby` (`lastupdatedby`),
  KEY `fk_merchant_approvedbyid` (`approvedbyid`),
  KEY `index_merchant_type` (`type`),
  KEY `index_merchant_isapproved` (`isapproved`),
  ...
  CONSTRAINT `fk_merchant_createdby` FOREIGN KEY (`createdby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_merchant_lastupdatedby` FOREIGN KEY (`lastupdatedby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `order` (
  ...
  KEY `fk_order_lastupdatedbyid` (`lastupdatedby`),
  ...
  CONSTRAINT `fk_order_createdby` FOREIGN KEY (`createdby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_order_lastupdatedbyid` FOREIGN KEY (`lastupdatedby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `payment` (
  ...
  KEY `fk_payment_createdby` (`createdby`),
  KEY `fk_payment_lastupdatedby` (`lastupdatedby`),
  KEY `fk_payment_orderid` (`orderid`),
  KEY `fk_payment_verifiedby` (`verifiedbyid`),
  KEY `unique_payment_status` (`status`),
  CONSTRAINT `fk_payment_createdby` FOREIGN KEY (`createdby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_payment_lastupdatedby` FOREIGN KEY (`lastupdatedby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `product` (
  ...
  KEY `fk_product_lastupdatedby` (`lastupdatedby`),
  KEY `fk_product_createdby` (`createdby`),
  ...
  CONSTRAINT `fk_product_createdby` FOREIGN KEY (`createdby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_product_lastupdatedby` FOREIGN KEY (`lastupdatedby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `store` (
  ...
  KEY `fk_store_createdby` (`createdby`),
  KEY `fk_store_lastupdatedby` (`lastupdatedby`),
  KEY `index_store_username` (`username`),
  CONSTRAINT `fk_store_lastupdatedby` FOREIGN KEY (`lastupdatedby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_store_createdby` FOREIGN KEY (`createdby`) REFERENCES `useraccount` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- ----------------------------
INSERT INTO `useraccount` VALUES ('1', '1', 'Edward', 'Lawrence', 'Peterson', 'admin', 'admin@devmail.infomacorp.com', null, null, null, '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', '1', '1950-01-01', '1', '', '2013-05-01 01:33:10', '1', null, '', '', '', null, null, '2012-09-07 10:06:57', '1', null, null, null, null, null, null);
